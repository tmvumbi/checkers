-- Operations metrics for the admin console: daily activity series,
-- lifetime totals, and a realtime snapshot. Only the service role (the
-- checkers-admin worker) may call it.
