                    ...
                    child: Row(
                      children: [
                        ...
                        CheckersSquareIconButton(
                          ...
                          onPressed: () =>
                              showTournamentInstructions(context),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: summary.isFinished
                        ...
                        : Row(
                            children: [
                              ...
                              Text(
                                TranslationKeys.tournamentPlayersCount
                                    .trParams({
                                      'count':
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          for (final match in detail.matches.where(
                            (m) => m.stage == stage,
                          ))
                            _MatchCard(detail: detail, match: match),
                        ],
                      ),
                    ),
                  ],
...
class _MatchCard extends GetView<TournamentController> {
  const _MatchCard({required this.detail, required this.match});
    ...
    Widget playerRow(String uid) {
      ...
      return Row(
        children: [
          ...
          if (isWinner)
            Icon(Icons.emoji_events, size: 16, color: brand.brandGold),
        ],
      );
    }
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: match.isFinished
                ...
                : brand.brandGold.withValues(alpha: 0.8),
            width: match.isFinished ? 1 : 2,
          ),
        ),
        child: Column(
          children: [
            playerRow(match.p1Uid),
            const SizedBox(height: 6),
            playerRow(match.p2Uid),
            if (!match.isFinished) ...[
              const SizedBox(height: 6),
              Row(
...
class _TableView extends GetView<TournamentController> {
  ...
  Widget build(BuildContext context) {
    ...
    String nameOf(String uid) =>
        controller.playerOf(uid)?.nickname ?? '?';
